...
function bogatiy_pavel_portfolio_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'bogatiy-pavel-portfolio' ),
		) );
...
//подключаем скрипты темы
	...
	//var_dump(wp_deregister_script('jquery'););

	//wp_enqueue_script( 'gutenberg-grid', get_template_directory_uri().'dev/app/libs/gutenberg-web-type/src/js/main.js', array(), null, true ); 

	//wp_enqueue_script( 'bogatiy-pavel-portfolio-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	//wp_enqueue_script( 'bogatiy-pavel-portfolio-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
